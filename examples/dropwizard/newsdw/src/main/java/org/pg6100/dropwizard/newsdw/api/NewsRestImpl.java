package org.pg6100.dropwizard.newsdw.api;

import com.google.common.base.Strings;
import com.google.common.base.Throwables;
import io.swagger.annotations.ApiParam;
import org.pg6100.dropwizard.newsdw.DatabaseBean;
import org.pg6100.dropwizard.newsdw.dto.NewsConverter;
...
public class NewsRestImpl implements NewsRestApi {
    ...
    private final DatabaseBean ejb = new DatabaseBean();

    /*
        Following is just a copy&paste. Only tricky thing in this
        class is that we cannot use @EJB, as we are not in a JEE
        container
     */
